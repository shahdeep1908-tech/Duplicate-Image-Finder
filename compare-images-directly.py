...
if __name__ == "__main__":
    # folder1_path = "./folder-1"
    folder1_path = "./To_Find"
    # folder2_path = "./folder-2"
    folder2_path = "./Master_Data"
    similarity_threshold = 0.9  # Adjust this threshold as per your requirement

    similar_images = find_similar_images(folder1_path, folder2_path, similarity_threshold)
    ...
    # Write the similar images to an Excel file
    workbook = Workbook()
    sheet = workbook.active
    sheet.title = "Similar Images"

    sheet.append(["To_Find", "Master_Data"])  # Add header

    for image1, image2 in similar_images:
        sheet.append([image1.split('/')[-1], image2.split('/')[-1]])

    excel_file_path = "./similar_images_data.xlsx"
